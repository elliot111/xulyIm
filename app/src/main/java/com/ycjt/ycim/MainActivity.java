...
import com.hyphenate.easeui.chat.ChatActivity;
...
import com.ycjt.ycim.ui.SettingsFragment;
...
//                startActivity(new Intent(MainActivity.this, ChatActivity.class).putExtra(EaseConstant.EXTRA_USER_ID, user.getUsername()));
                startActivity(new Intent(MainActivity.this, ChatActivity.class).putExtra(EaseConstant.EXTRA_USER_ID, "17600328877"));
            }
        });
    ...
    private Map<String, EaseUser> getContacts(){
        ...
        for(int i = 1; i <= 10; i++){
            ...
            user.setAvatar("http://pic13.nipic.com/20110409/7119492_114440620000_2.jpg");
